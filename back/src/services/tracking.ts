...
// ============================================================
export async function loggerConsultationMenu(
  menuId: number,
...
export async function loggerCreationCommande(
  ...
  try {
    console.log("🔵 loggerCreationCommande appelee avec :", {
      numeroCommande,
      menuId,
      utilisateurId,
    });
    ...
    console.log("🟢 Evenement cree avec succes !");
  } catch (erreur) {
    console.error("🔴 Erreur tracking creation commande :", erreur);
  }
}
// ============================================================
// LOGGER L'ANNULATION D'UNE COMMANDE
// ============================================================
export async function loggerAnnulationCommande(
  numeroCommande: string,
  utilisateurId: number,
) {
  try {
...
// ============================================================
export async function loggerPublicationAvis(
  avisId: number,
  utilisateurId: number,
  note: number,
) {
